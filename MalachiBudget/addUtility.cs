...
namespace MalachiBudget
{
    ...
    {       
            ...
            public addUtility(MySqlConnection connection, string _currentUser)
            {
                InitializeComponent();
            ...
            private void cmbSubmit_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        $"Values ('{currentUser}', 'utilities', {cellContents[0]}, {dblAmount}, '{fixedDate}', NULL, {cellContents[3]}, NULL, {cellContents[4]}, '{transID}');";
